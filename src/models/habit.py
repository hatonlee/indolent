"""SQLALchemy ORM models for habits and their completions."""
...
class Habit(Base):
    ...
    def __repr__(self):
        return f"<Habit(id={self.id}, name={self.name!r}, start_time={self.start_time!r}), \
        frequency={self.frequency}, done={self.completed()})>"
