...
### [0.1.0] - 2025-11-18
- For learning about SQLAlchemy and creating the boilerplate/setup in [db.py](../src/db.py).
- For creating the project skeleton adhering to the repository design principle (directories and some files).
- For learning tkinter and creating basic structure.
